    ...
    <main dir="rtl" className="min-h-screen bg-slate-50 text-slate-900">
      <header className="border-b bg-white">
        <div className="mx-auto max-w-7xl px-6 py-5">
          <Link
            href="/middle/third-year"
            className="text-sm font-semibold text-blue-700 hover:text-blue-900"
          >
            ← العودة إلى السنة الثالثة متوسط
          </Link>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            href={`/middle/third-year/${subject}/lessons`}
          ...
          <Link
            href={`/middle/third-year/${subject}/exercises`}
            className="rounded-2xl bg-white p-8 text-center shadow-md transition hover:-translate-y-1 hover:shadow-xl"
          >
            <div className="text-5xl">📝</div>
          ...
          <Link
            href={`/middle/third-year/${subject}/tests`}
            className="rounded-2xl bg-white p-8 text-center shadow-md transition hover:-translate-y-1 hover:shadow-xl"
          >
            <div className="text-5xl">🧪</div>
          ...
          <Link
            href={`/middle/third-year/${subject}/exams`}
            className="rounded-2xl bg-white p-8 text-center shadow-md transition hover:-translate-y-1 hover:shadow-xl"
          >
            <div className="text-5xl">📋</div>
